...
public:
  ...
  void setNiveau(std::string niveau, Carte carte);
  std::string getNiveau() const;
  void calculerNiveau();
  void ajouterCarte(Carte carte);
  friend void comparerPremierMain(Joueurs *joueurs, int nombreJoueurs);
  friend void comparerMainEtPlateau(Joueurs *joueurs, Plateau *plateau, int nombreJoueurs);
};
